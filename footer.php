<div id="newsletter">
  <form action="//catrobat.us11.list-manage.com/subscribe/post?u=5b5a960a1f0b53cf06ac2b5a2&amp;id=ce7367db20" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div style="text-align: center;">
      Subscribe to our Catrobat newsletter!
      <div>
        <div id="mc_embed_signup_scroll">
          <input size=30 type="email" value="" name="EMAIL" id="mce-EMAIL" placeholder="Your email">&nbsp;<input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button">
...
<div id="footer">
  <a href="https://www.facebook.com/Catrobat" target="_blank" title="Visit us on Facebook!"><img src="img/social_facebook.png" alt="Facebook" /></a>
